  ...
  return (
    <main className="w-full bg-[#f0ede6] text-gray-900 selection:bg-[#b7935b] selection:text-white pb-0 overflow-x-hidden -mb-16">
      ...
      <section className="pt-24 pb-20 px-6 max-w-6xl mx-auto w-full flex flex-col items-center text-center">
        <FadeUp>
          <span className="text-sm font-bold tracking-widest uppercase text-[#b7935b] mb-6 block">The Foundation of Beautiful Homes</span>
        </FadeUp>
        ...
        <FadeUp delay={0.2}>
          <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto font-medium leading-relaxed mb-10">
            Elevate your space with architectural Herringbone, authentic Engineered Wood, and ultra-durable AC5 Laminates. We combine industry-leading materials with flawless, laser-leveled installation.
          </p>
        </FadeUp>
        ...
        <FadeUp delay={0.3}>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="#collections" className="inline-block bg-white text-[#1a1814] border border-gray-200 px-8 py-4 font-bold tracking-widest uppercase text-sm hover:border-[#b7935b] transition-colors rounded-full shadow-sm text-center">
              Explore Collections
            </a>
          </div>
        </FadeUp>
          ...
          <FadeUp delay={0.1}>
            <div className="group relative h-[450px] overflow-hidden rounded-xl bg-gray-200">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent flex flex-col justify-end p-8 md:p-12">
                ...
                <Link href="/Service/wood-flooring" className="text-[#b7935b] font-bold uppercase tracking-widest text-xs hover:text-white transition-colors">View Range &rarr;</Link>
              </div>
            </div>
          </FadeUp>
